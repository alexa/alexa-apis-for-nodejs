...
export namespace v1.skill.AlexaHosted {
     ...
     * @enum
     */
    export type HostedSkillRuntime = 'NODE_10_X' | 'PYTHON_3_7' | 'NODE_12_X' | 'NODE_16_X';
}
...
export namespace v1.skill.Manifest {
     ...
     * @interface
     */
    export interface AlexaDataStorePackageManagerImplementedInterface {
        /**
...
export namespace v1.skill.Manifest {
    ...
    * @interface
    */
    export type Interface = v1.skill.Manifest.AlexaSearch | v1.skill.Manifest.AlexaPresentationAplInterface | v1.skill.Manifest.AppLinkInterface | v1.skill.Manifest.AlexaPresentationHtmlInterface | v1.skill.Manifest.AudioInterface | v1.skill.Manifest.GameEngineInterface | v1.skill.Manifest.AppLinkV2Interface | v1.skill.Manifest.AlexaDataStorePackageManagerInterface | v1.skill.Manifest.DisplayInterface | v1.skill.Manifest.GadgetControllerInterface | v1.skill.Manifest.VideoAppInterface;
}
...
export namespace v1.skill.Manifest {
     ...
     * @enum
     */
    export type InterfaceType = 'AUDIO_PLAYER' | 'VIDEO_APP' | 'RENDER_TEMPLATE' | 'GAME_ENGINE' | 'GADGET_CONTROLLER' | 'CAN_FULFILL_INTENT_REQUEST' | 'ALEXA_PRESENTATION_APL' | 'ALEXA_CAMERA_PHOTO_CAPTURE_CONTROLLER' | 'ALEXA_CAMERA_VIDEO_CAPTURE_CONTROLLER' | 'ALEXA_FILE_MANAGER_UPLOAD_CONTROLLER' | 'CUSTOM_INTERFACE' | 'ALEXA_AUGMENTATION_EFFECTS_CONTROLLER' | 'APP_LINKS' | 'ALEXA_EXTENSION' | 'APP_LINKS_V2' | 'ALEXA_SEARCH' | 'ALEXA_DATASTORE_PACKAGEMANAGER' | 'ALEXA_DATA_STORE';
}
